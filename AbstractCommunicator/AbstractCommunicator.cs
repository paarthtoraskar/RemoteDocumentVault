...
namespace RDV
{
    ...
    public abstract class AbstractCommunicator : ICommService
    {
    ...
    ///////////////////////////////////////////////////////////////////////
    // AbstractMessageDispatcher 
    // - serves as message router between message-passing parts
    ...
    public abstract class AbstractMessageDispatcher : AbstractCommunicator
    {
        ...
        public Dictionary<string, ICommService> CommunicatorLookup = new Dictionary<string, ICommService>();
        ...
        protected override void ProcessMessages()
        {
            while (true)
            {
                ...
                else if (msg.TargetCommunicator == this.Name && (string)msg.Contents == "quit")  // quit if sent to me
                {
                    if (Verbose)
                        Console.Write("\n  dispatcher stopping");
                    break;
                ...
                {
                    if (CommunicatorLookup.ContainsKey("ServerSender"))
                        CommunicatorLookup["ServerSender"].PostMessage(msg);
                    else
