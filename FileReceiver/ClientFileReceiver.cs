...
namespace RDV
{
    ...
    public class ClientFileReceiver : IFileService
    {
        ...
        ServiceHost CreateChannel(string url)
        {
            ...
            Type service = typeof(RDV.ClientFileReceiver);
        ...
        //    ServiceHost fs = CreateChannel("http://localhost:8090/FileService");
        //    fs.Open();
        ...
        {
            ClientFileReceiver fileReceiver = new ClientFileReceiver();

            Console.Write("\n  File Transfer Service running:");
            Console.Write("\n ================================\n");

            ServiceHost host = fileReceiver.CreateChannel("http://localhost:8090/FileService");
            host.Open();
