...
namespace RDV
{
    ...
    class Client
    {
        static void Main(string[] args)
        {
            ...
            ServiceMessage msg1 = ServiceMessage.MakeMessage("echo", "Client", "<root>some echo stuff</root>", "no name");
            ...
            ServiceMessage msg2 = ServiceMessage.MakeMessage("query", "Client", "<root>some query stuff</root>", "no name");
            ...
            ServiceMessage msg3 = ServiceMessage.MakeMessage("nav", "Client", "<root>some nav stuff</root>", "no name");
